...
\begin{figure}[h!]
\centering
	\includegraphics[width = 1 \textwidth]{TotCurr_Extrude_iiee_less_prolonged.pdf}
...
\begin{figure}[h!]
\centering
	\includegraphics[width = 1 \textwidth]{GT170_totCurr_steady_sate.eps}
...
\begin{figure}[h!]
\centering
	\includegraphics[width = 1 \textwidth]{GT170_totCurr_iiee.eps}
