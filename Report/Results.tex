...
Now, let us focus on one of the other designed geometries for TREX, the so called \emph{extrude} geometry, that is with half an ellipse dug inside the cathode. The electrode geometry has been shown previously in Fig.(\ref{config_trapped}). Here again, the anode is grounded, and the cathode is set at the potential $\Phi = -20$ kV.
