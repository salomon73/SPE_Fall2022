...
cd /Users/salomonguinchard/Documents/GitHub/SPE_Fall2022/Inputs/Test_ions2
...
EnergyRange = 1e-3*[min(Energy), max(Energy)];
RangeOfInterest = E(find(E>EnergyRange(1) & E<EnergyRange(2)));
...
figure
    ...
    hold on
    plot(E(find(E>EnergyRange(1) & E<EnergyRange(2))), Eloss(find(E>EnergyRange(1) & E<EnergyRange(2))), 'bo-');

DegFit = 10;
P = polyfit(E(find(E>EnergyRange(1) & E<EnergyRange(2))), Eloss(find(E>EnergyRange(1) & E<EnergyRange(2))),DegFit)
y = polyval(P,E(find(E>EnergyRange(1) & E<EnergyRange(2))));

    hold on 
    plot(E(find(E>EnergyRange(1) & E<EnergyRange(2))),y, 'k-');

    ylabel('$\frac{dE}{dx}$ [Mev/cm]', 'interpreter', 'latex','Fontsize', 22)
    xlabel('$E$ [Mev]', 'interpreter', 'latex', 'Fontsize', 22)
    legend('1', '2','3','4','5', 'Location','northwest','Interpreter','latex');
    set(legend,'FontSize',18);
    set (gca, 'fontsize', 20)
...
figure 
plot(E(find(E>EnergyRange(1) & E<EnergyRange(2))), Yield, 'ro-', 'Linewidth', 2);
