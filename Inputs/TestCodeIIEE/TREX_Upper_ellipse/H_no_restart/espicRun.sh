...
res_folder='/scratch/sguincha/TestCodeIIEE/TREX/Results/'
mkdir -p $res_folder
cat > job.in << EOM 
...
&BASIC
  ...
  n0=-3e17, dt=5E-11                    !Initial plasma density in plasmadim
