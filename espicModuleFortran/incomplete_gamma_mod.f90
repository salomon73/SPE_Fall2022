...
! DESCRIPTION:
!
!> Module containing functions enabling to compute 
!> incomplete gamma values to generate random values following gamma
!> distribution (see ion_induced_mod.f90 -> gen_E_gamma)
!------------------------------------------------------------------------------
